...
import 'new_exam_quiztest_all_question_mock.dart';
import 'new_exam_quiztest_mock.dart';



class NewExamInstructionPage extends StatefulWidget {
  final int paperId;
  final int exmaTime;
  ...
  const NewExamInstructionPage({super.key, required this.paperId, required this.exmaTime, required this.papername, required this.question, required this.marks, required this.type, required this.subject, required this.endTime,});
  @override
  _InstructionPageState createState() => _InstructionPageState();
}

class _InstructionPageState extends State<NewExamInstructionPage> {
                  ...
                  child: Row(
                    ...
                    children: [
                      Radio<String>(
                        ...
                        activeColor: primaryColor, // Set the selected color to black
                        ...
                        onTap: () {
                          ...
                          if (_selectedOption=='all_questions') {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => NewExamAllQuestionMockQuizScreen(
                                  paperId: widget.paperId,
                                  papername: widget.papername,
                                  exmaTime: widget.exmaTime != null ? widget.exmaTime as int : 0,
                                  question: widget.question,
                                  marks: widget.marks, type: widget.type,
                                  subject: widget.subject, endTime: '${widget.endTime.toString()}',
                                ),
                              ),
                            );
                          } else {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => NewExamMockQuizScreen(
                                  ...
                                  exmaTime: widget.exmaTime != null ? widget.exmaTime as int : 0,
                                  question: widget.question,
                                  marks: widget.marks, type: widget.type, endTime: '${widget.endTime.toString()}',
                                ),
                              ),
                            );
