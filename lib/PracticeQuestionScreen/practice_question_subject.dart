...
import '../CommonCalling/data_not_found_whiteScreen.dart';
...
class PracticeQuestionSubjectScreen extends StatefulWidget {
  final int paperId;
  final int exmaTime;
  ...
  const PracticeQuestionSubjectScreen(
      {super.key,
        required this.paperId,
        required this.papername,
        required this.exmaTime, required this.question, required this.marks, required this.sunjectId});

  @override
  _QuizScreenState createState() => _QuizScreenState();
}

class _QuizScreenState extends State<PracticeQuestionSubjectScreen> {
  ...
  Future<void> hitQuestionApi() async {
    ...
    final response = await http.get(
      Uri.parse('${subjectWisePracticeQuestion}${widget.sunjectId}'),  // Replace with your API URL
      // Uri.parse('${'http://192.168.1.6/ksquiz/api/question/64073'}'),  // Replace with your API URL
      headers: {
      ...
      builder: (context, onInit, onDispose) => WillPopScope(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Center(
              child: Text('Practice Question 24/7',
          ...
          Column(
            children: [
              paperList.isEmpty
                  ? Center(child: DataNotFoundWhiteScreenWidget())
                  :
              Stack(
                children: [
                  Center(
                        ...
                        Padding(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                if ( paperList[_currentQuestionIndex]['question_image_url']!=null)
                                  Row(
                                    children: [
                                            Text(
                                      ...
                                      Expanded(
                                        child: SizedBox(
                                          height: 50.sp,
                                            // width: double.infinity,
                                            child: Image.network( paperList[_currentQuestionIndex]['question_image_url'].toString(),)),
                                      ),
                                    ],
                                  ), // Display Question Image
                                if (paperList[_currentQuestionIndex]['question']!='')
                                  Padding(
                                    padding: const EdgeInsets.symmetric(vertical: 8.0),
                                    child: (paperList[_currentQuestionIndex]['question']!=null)? Text('${_currentQuestionIndex + 1}.  ${paperList[_currentQuestionIndex]['question']}'
                                      ,
                                ...
                                // if ( paperList[_currentQuestionIndex]['question_image_url'] == null ||  paperList[_currentQuestionIndex]['question'] != null)
                                //   Text(
                                //     '${_currentQuestionIndex + 1}. ${ paperList[_currentQuestionIndex]['question']}',
                                //     style: TextStyle(
                                //       fontSize: 16.sp,
                                //       fontWeight: FontWeight.normal,
                                //       color: Colors.black,
                                ...
                                //           child: Container(
                                //             child: Image.network(
                                //               paperList[_currentQuestionIndex]['question_image_url'].toString(),
                                //               fit: BoxFit.fill,
                                //             ),
                                //           ),
                                //         ),
                                ...
                                //
                                // if ( paperList[_currentQuestionIndex]['question_image_url'] != null &&
                                //     paperList[_currentQuestionIndex]['question'] != null)
                                //   SizedBox(
                                //     height: 100.sp,
                                //     child: Image.network(
                                //       paperList[_currentQuestionIndex]['question_image_url'].toString(),
                                ...
                                SizedBox(height: 20),
                                Column(
                                  children: ( paperList[_currentQuestionIndex]['options'] as List<dynamic>)
                                      .asMap()
                                      .entries
                                      .map<Widget>((entry) {
                                    ...
                                    return Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          _selectAnswer(index);
                                          hitPracticeApi(
                                              questionId:  paperList[_currentQuestionIndex]['id'],
                                              selectedOption: index,
                                              // answer:  paperList[_currentQuestionIndex]['answer'],
                                              subjectId:  paperList[_currentQuestionIndex]['subject_id']);
                                    ...
                                    children: [
                                      Column(
                                        children: [
                                          ...
                                          Text('${ paperList[_currentQuestionIndex]['explanation'].toString()}'),
                                          if ( paperList[_currentQuestionIndex]['explanation_image'] != null)
                                            Image.network( paperList[_currentQuestionIndex]['explanation_image'].toString()),
                                        ],
                                      ),
                                    ],
                                  ),
