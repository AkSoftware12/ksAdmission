...
class BestCollegesScreen extends StatefulWidget {
  final String rank;

  const BestCollegesScreen({super.key, required this.rank,});

  @override
  State<BestCollegesScreen> createState() => _BestCollegesScreenState();
}

class _BestCollegesScreenState extends State<BestCollegesScreen> {
  ...
  Future<void> collegeList(String rank, String course, String category, String quota) async {
    ...
    var url = Uri.parse(counselingToolTopTen);
